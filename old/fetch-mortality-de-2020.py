...
assert df2.iloc[0]["Date"] == "2020-02-28", "Error of start date, expecting 2020-02-28"
...
if not helper.check_cache_file_available_and_recent(
    fname=excelFile, max_age=0, verbose=False
):
...
data = zip(
    l_dates, l_deaths2016, l_deaths2017, l_deaths2018, l_deaths2019, l_deaths2020
)

df = pd.DataFrame(data, columns=["Day", "2016", "2017", "2018", "2019", "2020"])
